...
def index():
    ...
    if request.method == 'POST':
        ...
        cur.execute("INSERT INTO order (resi,namaPengirim,namaPenerima,no_telp_pengirim,no_telp_penerima,alamat_penerima,beratBaang,tgl_pengiriman,hargaTotal,nip,id_kota,id_status,estimasi) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)", (a,b,c,d,e,f,g,h,i,j,k,l,m))
